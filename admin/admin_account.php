...
<head>
    ...
    <title>green tea admin panel - register admin's</title>
</head>
<body>
    <?php
    ...
    <div class="main">
        ...
        <section class="acconts">
            ...
            ?>
            <div class="box">
                <p>admin id: <span><?=$fetch_user['id']?></span></p>
                <p>admin name: <span><?=$fetch_user['name']?></span></p>
                <p>admin email: <span><?=$fetch_user['email']?></span></p>
