    ...
    if(isset($_POST['submit'])){
        ...
        if ($select_user->rowCount() > 0){
            ...
            if ($pass != $cpass){
                ...
                $insert_user = $conn->prepare("INSERT INTO `admin` (id, name, email, password,profile) VALUES (?, ?, ?, ?, ?)");
    ...
    <div class="main-container">
        <section class="form-container">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="input-field">
                    <p>select profile <sup>*</sup></p>
                    <input type="file" name="image" accept="image/*">
                </div>

                <input type="submit" value="register now" name="submit" style=" text-align: center; text-transform:capitalize;">
