    ...
    if(isset($_POST['place_order'])){
        ...
        if(isset($_GET['get_id'])){
            ...
            while ($fetch_c = $verify_cart->fetch(PDO::FETCH_ASSOC)) {
                $insert_order = $conn->prepare("INSERT INTO `orders` (id,user_id,name,number,email, address, address_type, method,product_id,price,qty) values(?,?,?,?,?,?,?,?,?,?,?)");
                $insert_order->execute([unique_id(),$user_id,$name,$number,$email,$address,$address_type,$method,$fetch_c['product_id'],$fetch_c['price'],$fetch_c['qty']]);
                header('location: order.php');
            }
            if($insert_order){
        ...
        <section class="checkout">
            <div class="tilte">
                ...
                <p>
                    ...
                    psum saepe error deleniti veritatis consequuntur ab numquam quis. 
                </p>
            </div>
            <div class="row">
                    ...
                    <div class="flex">
                        ...
                        <div class="box">
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" name="pincode" required maxlength="6" min="0" max="999999" placeholder="110022" class="input">
                            </div>
                        </div>
                    </div>
                ...
                <div class="summary">
                    ...
                    <div class="box-container">
                        ...
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="price">DT<?php echo $fetch_get['price']; ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="price">DT<?php echo $fetch_product['price']; ?> X <?php echo $fetch_cart['qty']; ?>  </p>
                            </div>
                        </div>
                        <?php
                                    }
                    ...
                    <div class="grand-total">
                        <span>total amount payable : DT<?php echo $grand_total; ?> </span>
                    </div>
                </div>
            </div>
